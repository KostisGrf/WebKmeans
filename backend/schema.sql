...
--
-- Dumping routines for database 'web_kmeans'
--
...
INSERT INTO verification_tokens(userid,token) VALUES (useridd,token);
END ;;
DELIMITER ;
...
SET users.password=new_password where verification_tokens.token=vtoken;

DELETE FROM verification_tokens where token=vtoken;
...
UPDATE users 
JOIN verification_tokens ON users.id=verification_tokens.userid
SET users.verified=1 where verification_tokens.token=vtoken;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `verifyDelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
JOIN verification_tokens ON users.id=verification_tokens.userid
WHERE verification_tokens.token=vtoken;
